...
##  BLAST: поиск пептидов в протеоме
...
##  Извлечение последовательностей кандидатов
...
##  Предсказание субклеточной локализации
...
##  BLAST по базе UniProtKB/Swiss-Prot
...
##  Предсказание доменов Pfam (HMMER)
